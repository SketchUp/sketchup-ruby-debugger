...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/obirsoy/Downloads/ruby/ruby-install2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/obirsoy/Downloads/ruby/ruby-install2' '--enable-load-relative' '--with-static-linked-ext' '--enable-shared' '--with-openssl-dir=/Users/obirsoy/Downloads/ruby/ssl-install' '--without-debug' '--without-irb' '--without-mkmf' '--without-rdoc' '--without-tk' 'CFLAGS=-mmacosx-version-min=10.10 -isysroot /Applications/Xcode.7.2.1.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk'"
  ...
  CONFIG["CFLAGS"] = "-mmacosx-version-min=10.10 -isysroot /Applications/Xcode.7.2.1.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -fno-common -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "clang"
